...
<html lang="tr">
	...
	<head><base href="/"/>
		...
		<meta charset="utf-8" />
		<meta name="description" content="Admin Kontrol Paneli | ModelOtomotiv" />
						...
						<div id="kt_app_footer" class="app-footer">
							...
							<div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
								...
								<div class="text-dark order-2 order-md-1">
									...
									<a href="https://site.modelotoparca.com" target="_blank" class="text-gray-800 text-hover-primary">Model Otomotiv</a>
								</div>
								<!--end::Copyright-->
								<!--begin::Menu-->
