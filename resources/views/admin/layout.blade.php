								...
								<div class="app-navbar-item ms-1 ms-lg-3">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
										...
										<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('assets/media/misc/menu-header-bg.jpg')">
											<!--begin::Title-->
											<h3 class="text-white fw-semibold mb-3">E-Ticaret Platformlar</h3>
											<!--end::Title-->
											<!--begin::Status-->
											<span class="badge bg-primary py-2 px-3">0 Bekleyen İşlem</span>
											<!--end::Status-->
										</div>
										<!--end::Heading-->
										<!--begin:Nav-->
										<div class="row g-0">
											...
											<div class="col-6">
												<a href="admin/apps/projects/budget" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
													...
													<!--end::Svg Icon-->
													<span class="fs-5 fw-semibold text-gray-800 mb-0">Web Site</span>
													<span class="fs-7 text-gray-400">modelotoparca.com</span>
												</a>
											</div>
											<!--end:Item-->
											<!--begin:Item-->
											<div class="col-6">
												<a href="admin/apps/projects/settings" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
													...
													<!--end::Svg Icon-->
													<span class="fs-5 fw-semibold text-gray-800 mb-0">N11 Modelotoparca</span>
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							<!--begin::Logo image-->
							<a href="admin/index">
								<img alt="Logo" src="https://site.modelotoparca.com/storage/imported_images/dark-logo.png" class="h-30px app-sidebar-logo-default" />
