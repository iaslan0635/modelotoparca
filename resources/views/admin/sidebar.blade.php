<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    >
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link" href="{{ route("admin.products.merchant-index") }}">
                    <span class="menu-icon">
                        <!--begin::Svg Icon-->
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                    ...
                    <span class="menu-title">Pazaryerindeki ürünler</span>
                </a>
                <!--end:Menu link-->
            </div>
            <!--end:Menu item-->
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link" href="{{ route("admin.products.bot") }}">
                    <span class="menu-icon">
                        <!--begin::Svg Icon-->
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                    ...
                    <span class="menu-title">Bot ile çekilen ürünler</span>
                </a>
                <!--end:Menu link-->
            </div>
            <!--end:Menu item-->
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link" href="{{ route("admin.products.non-bot") }}">
                    <span class="menu-icon">
                        <!--begin::Svg Icon-->
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                    ...
                    <span class="menu-title">Bot ile çekilmeyen ürünler</span>
                </a>
                <!--end:Menu link-->
            </div>
            <!--end:Menu item-->
