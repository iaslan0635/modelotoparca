...
<head>
    ...
    @if (theme()->getViewMode() === 'preview')
        {{ theme()->getview('admin.partials/trackers/_ga-general') }}
        {{ theme()->getview('admin.partials/trackers/_ga-tag-manager-for-head') }}
    @endif
...
@if (theme()->getViewMode() === 'preview')
    {{ theme()->getview('admin.partials/trackers/_ga-tag-manager-for-body') }}
@endif
