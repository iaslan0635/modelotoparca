			...
			<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
				...
				<ul class="nav flex-wrap border-transparent fw-bold">
					...
					<li class="nav-item my-1">
						<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" href="/admin/apps/support-center/overview.html">Overview</a>
					</li>
					<!--end::Nav item-->
					<!--begin::Nav item-->
					<li class="nav-item my-1">
			...
			<div class="card card-md-stretch me-xl-3 mb-md-0 mb-6">
				...
				<div class="card-body p-10 p-lg-15">
					...
					<div class="d-flex flex-stack mb-7">
						...
						<div class="d-flex align-items-center">
							<!--begin::Link-->
							<a href="/admin/apps/support-center/tutorials/list.html" class="text-primary fw-bold me-1">All Tutorials</a>
							<!--begin::Link-->
							<!--begin::Arrow-->
							<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
							<span class="svg-icon svg-icon-2 svg-icon-primary">
