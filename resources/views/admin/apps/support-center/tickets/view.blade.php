								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_631f08ff8e3a7">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_631f08ff8e3a7" data-allow-clear="true">
																<option></option>
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="admin/dist/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Sandra Piquet</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="admin/dist/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Bob Clarcson</a>
																						<!--end::Username-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="admin/dist/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Matthew</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="admin/dist/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Boris</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
