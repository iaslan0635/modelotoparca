        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Rol Listesi</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                <!--begin::Actions-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-5 g-xl-9">
                    @can("Kullanıcı İşlemleri.Roller.Listele")
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card card-flush h-md-100">
                                    ...
                                    <div class="card-footer flex-wrap pt-0">
                                        @can("Kullanıcı İşlemleri.Roller.İzinleri Görüntüle")
                                            <a href="{{ route('admin.role.show', $role) }}" class="btn btn-light btn-active-primary my-1 me-2">
                                                Görüntüle
                                            </a>
                                        @endcan
                                        @can("Kullanıcı İşlemleri.Roller.İzinleri Düzenle")
                                            <a href="{{ route('admin.role.edit', $role) }}" class="btn btn-light btn-active-light-primary my-1">
                                                İzinleri Düzenle
                                            </a>
                                        @endcan
                                        @can("Kullanıcı İşlemleri.Roller.Sil")
                        ...
                        @endforeach
                    @endcan
                    @can("Kullanıcı İşlemleri.Roller.Ekle")
                        <!--begin::Add new card-->
                        <div class="ol-md-4">
                            <!--begin::Card-->
