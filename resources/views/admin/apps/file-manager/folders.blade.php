			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					...
					<div class="m-0">
						...
						<!--end::Menu toggle-->
						<!--begin::Menu 1-->
						<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_631f091fc284e">
							<!--begin::Header-->
							<div class="px-7 py-5">
							...
							<div class="px-7 py-5">
								...
								<div class="mb-10">
									...
									<!--begin::Input-->
									<div>
										<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_631f091fc284e" data-allow-clear="true">
											<option></option>
								...
								<tr>
									...
									<td data-order="account">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">account</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
											...
											<div class="ms-2">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
													...
													<div class="menu-item px-3">
														<a href="admin/dist/apps/file-manager/files" class="menu-link px-3">View</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
								...
								<tr>
									...
									<td data-order="apps">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">apps</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="widgets">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">widgets</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="assets">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">assets</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="documentation">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">documentation</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="layouts">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">layouts</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="modals">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">modals</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="authentication">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">authentication</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="dashboards">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">dashboards</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="media">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">media</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="customers">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">customers</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="user-management">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">user-management</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="subscriptions">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">subscriptions</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="forms">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">forms</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="buttons">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">buttons</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="datatables">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">datatables</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="index">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">index</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
								...
								<tr>
									...
									<td data-order="landing">
										<div class="d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<a href="admin/dist/apps/file-manager/files/" class="text-gray-800 text-hover-primary">landing</a>
										</div>
									</td>
									<!--end::Name=-->
									<!--begin::Size-->
