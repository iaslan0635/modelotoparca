    ...
    <div class="d-flex flex-column flex-column-fluid">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_631f08ee5f87f" data-allow-clear="true">
                                            <option></option>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form action="{{ route('admin.order.update', $order) }}" method="POST" class="form d-flex flex-column flex-lg-row"
                      data-kt-redirect="{{ route('admin.order.list') }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Aside column-->
                                ...
                                <div class="d-flex flex-column gap-10">
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                                data-placeholder="Select an option" name="payment_status"
                                                id="kt_ecommerce_edit_order_payment">
                                            <option></option>
                                            @foreach(\App\Enums\OrderStatuses::cases() as $status)
                                                <option
                                                    value="{{ $status->value }}" {{ $status->value === $order->payment_status ? "selected":null }}>{{ __("status.".$status->value) }}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Select2-->
                                        <!--begin::Description-->
                    ...
                    <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">87.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">242.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">85.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">221.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">60.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">248.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">84.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">91.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">62.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">200.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">272.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">264.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">186.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">21.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">40.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">148.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">265.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">254.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">56.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fw-semibold fs-7">Price: $
                                                            <span
                                                                data-kt-ecommerce-edit-order-filter="price">203.00</span>
                                                        </div>
                                                        <!--end::Price-->
                                                        <!--begin::SKU-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="admin/apps/ecommerce/catalog/products" id="kt_ecommerce_edit_order_cancel"
