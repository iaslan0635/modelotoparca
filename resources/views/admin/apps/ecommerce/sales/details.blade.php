		...
		<div id="kt_app_content_container" class="app-container container-xxl">
			...
			<div class="d-flex flex-column gap-7 gap-lg-10">
				<div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
					...
					<!--end:::Tabs-->
					<!--begin::Button-->
					<a href="admin/apps/ecommerce/sales/listing" class="btn btn-icon btn-light btn-sm ms-auto me-lg-n7">
					...
					<!--end::Button-->
					<!--begin::Button-->
					<a href="admin/apps/ecommerce/sales/edit-order" class="btn btn-success btn-sm me-lg-n7">Edit Order</a>
					<!--end::Button-->
					<!--begin::Button-->
					<a href="admin/apps/ecommerce/sales/add-order" class="btn btn-primary btn-sm">Add New Order</a>
					<!--end::Button-->
				</div>
				<!--begin::Order summary-->
								...
								<table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr>
											...
											<td class="fw-bold text-end">
												<div class="d-flex align-items-center justify-content-end">
													...
													<!--end::Avatar-->
													<!--begin::Name-->
													<a href="admin/apps/ecommerce/customers/details" class="text-gray-600 text-hover-primary">Dan Wilson</a>
													<!--end::Name-->
												</div>
											</td>
										</tr>
										...
										<tr>
											...
											<td class="fw-bold text-end">
												<a href="admin/apps/user-management/users/view" class="text-gray-600 text-hover-primary">dam@consilting.com</a>
											</td>
										</tr>
										<!--end::Payment method-->
										<!--begin::Date-->
								...
								<table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr>
											...
											<td class="fw-bold text-end">
												<a href="admin/apps/invoices/view/invoice-3" class="text-gray-600 text-hover-primary">#INV-000414</a>
											</td>
										</tr>
										<!--end::Invoice-->
										<!--begin::Shipping-->
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<!--begin::Title-->
															<div class="ms-5">
																<a href="admin/apps/ecommerce/catalog/edit-product" class="fw-bold text-gray-600 text-hover-primary">Product 1</a>
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<!--begin::Title-->
															<div class="ms-5">
																<a href="admin/apps/ecommerce/catalog/edit-product" class="fw-bold text-gray-600 text-hover-primary">Footwear</a>
																<div class="fs-7 text-muted">Delivery Date: 12/09/2022</div>
															</div>
															<!--end::Title-->
														</div>
