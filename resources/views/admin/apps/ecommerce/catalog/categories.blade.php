                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option"
                                                data-dropdown-parent="#kt_menu_631f08e1de63a" data-allow-clear="true">
                                            <option></option>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" class="form-control form-control-solid w-250px ps-14" placeholder="Search Category"/>
                            </div>
                            <!--end::Search-->
                        </div>
                        --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div
                                                ...
                                                data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                @can(permissions("Stok Yönetimi.Kategoriler.Düzenle.*"))
                                                ...
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                @can("Stok Yönetimi.Kategoriler.Sil")
                                                    <div class="menu-item px-3">
