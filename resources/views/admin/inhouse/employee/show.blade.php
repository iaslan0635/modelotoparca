    ...
    <div class="d-flex flex-column flex-lg-row">
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <!--end::Avatar-->
                        <!--begin::Name-->
                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $employee->full_name }}</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="mb-9">
                            <!--begin::Badge-->
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        ...
                        <span>
                            <a href="{{ route('admin.employee.edit', $employee) }}" class="btn btn-sm btn-light-primary">Düzenle</a>
                        </span>
                    </div>
                    <!--end::Details toggle-->
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">{{ $employee->id }}</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                ...
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4 active" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#permissions_tab">İzinler</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <!--end:::Tab pane-->
                <!--begin:::Tab pane-->
                <div class="tab-pane fade show active" id="permissions_tab" role="tabpanel">
                    <!--begin::Card-->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Badge=-->
                                        <!--begin::Status=-->
                                        <td>POST /v1/invoices/in_7515_5438/payment</td>
                                        <!--end::Status=-->
                                        <!--begin::Timestamp=-->
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Badge=-->
                                        <!--begin::Status=-->
                                        <td>POST /v1/invoices/in_6509_8838/payment</td>
                                        <!--end::Status=-->
                                        <!--begin::Timestamp=-->
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Badge=-->
                                        <!--begin::Status=-->
                                        <td>POST /v1/invoice/in_1466_9864/invalid</td>
                                        <!--end::Status=-->
                                        <!--begin::Timestamp=-->
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Badge=-->
                                        <!--begin::Status=-->
                                        <td>POST /v1/invoices/in_7050_7062/payment</td>
                                        <!--end::Status=-->
                                        <!--begin::Timestamp=-->
