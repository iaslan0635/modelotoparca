...
@section("card-title", "Kullanıcı Ekle")
@section("card-content")
    <form class="form" action="{{ route('admin.user.store') }}" method="post">
        ...
        <div class="fv-row mb-7">
            ...
            <input id="signup-name" type="text" name="first_name" value="{{ old("first_name") }}"
        ...
        <div class="fv-row mb-7">
            ...
            <input id="signup-last-name" type="text" name="last_name" value="{{ old("last_name") }}"
