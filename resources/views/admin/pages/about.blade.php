				...
				<div class="mb-10">
					...
					<div class="overlay">
						...
						<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
							<a href="/admin/pages/pricing/pricing-2.html" class="btn btn-primary">Pricing</a>
			...
			<div class="card bg-light mb-18">
				...
				<div class="card-body py-15">
					...
					<div class="fs-2 fw-semibold text-muted text-center">
						<a href="/admin/account/security.html" class="link-primary fs-4 fw-bold">Marcus Levy</a>
