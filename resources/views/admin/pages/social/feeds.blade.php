		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="d-flex align-items-center gap-2 gap-lg-3">
				...
				<div class="m-0">
					...
					<!--end::Menu toggle-->
					<!--begin::Menu 1-->
					<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_631f08ccb186f">
						<!--begin::Header-->
						<div class="px-7 py-5">
						...
						<div class="px-7 py-5">
							...
							<div class="mb-10">
								...
								<!--begin::Input-->
								<div>
									<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_631f08ccb186f" data-allow-clear="true">
										<option></option>
							...
							<div class="m-0">
								...
								<ul class="nav nav-pills nav-pills-custom flex-column border-transparent fs-5 fw-bold">
									...
									<li class="nav-item mt-5">
										<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 active" href="admin/dist/pages/social/feeds">
				...
				<div class="w-100 flex-lg-row-fluid mx-lg-13">
					...
					<div class="card card-flush mb-10">
						...
						<div class="card-footer d-flex justify-content-end pt-0">
							<!--begin::Post action-->
							<a href="admin/dist/pages/blog/post" class="btn btn-sm btn-primary" id="kt_social_feeds_post_btn">
