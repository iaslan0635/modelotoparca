				...
				<div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
					...
					<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url('assets/media/patterns/vector-1.png')">
						...
						<div class="card-header pt-5">
							...
							<div class="card-title d-flex flex-column">
								<!--begin::Amount-->
								<span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{\App\Models\Product::all()->count()}}</span>
								<!--end::Amount-->
								<!--begin::Subtitle-->
								<span class="text-white opacity-75 pt-1 fw-semibold fs-6">Toplam Ürün Mevcuttur</span>
								<!--end::Subtitle-->
							</div>
							<!--end::Title-->
						</div>
					...
					<div class="card card-flush h-md-50 mb-5 mb-xl-10">
						...
						<div class="card-body d-flex flex-column justify-content-end pe-0">
							<!--begin::Title-->
							<span class="fs-6 fw-bolder text-gray-800 d-block mb-2">Bu Hafta Üye Olanlar</span>
							<!--end::Title-->
							<!--begin::Users group-->
						...
						<div class="card-header pt-5">
							...
							<div class="card-title d-flex flex-column">
								...
								<div class="d-flex align-items-center">
									...
									<!--end::Currency-->
									<!--begin::Amount-->
									<span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">0,000</span>
									<!--end::Amount-->
									<!--begin::Badge-->
								...
								<!--end::Info-->
								<!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-semibold fs-6">Haftanın Toplam Kazancı</span>
								<!--end::Subtitle-->
							</div>
							<!--end::Title-->
						</div>
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-800">Son Eklenen Ürünler</span>
                                <span class="text-gray-400 mt-1 fw-semibold fs-6">En Son Güncellenme Tarihi: 37 minutes ago</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                    ...
                                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                        <th class="p-0 pb-3 min-w-175px text-start">Ürün</th>
                                        <th class="p-0 pb-3 min-w-175px text-end">Miktarı</th>
                                        <th class="p-0 pb-3 min-w-100px text-end">Fiyat</th>
                                        <th class="p-0 pb-3 min-w-175px text-end pe-12">Durumu</th>
                                    ...
                                    <!--begin::Table body-->
                                    <tbody>
                                    @foreach(\App\Models\Product::orderBy('updated_at','desc')->limit(5)->get() as $product)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
				...
				<div class="col-xl-6 mb-5 mb-xl-10">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-header pt-5">
							<!--begin::Title-->
							<h3 class="card-title align-items-start flex-column">
								<span class="card-label fw-bold text-gray-800">Pazaryerleri Ürün Durumları</span>
								<span class="text-gray-400 mt-1 fw-semibold fs-6">(n11,trendyol,Hepsiburada)</span>
							</h3>
							<!--end::Title-->
							<!--begin::Toolbar-->
							<div class="card-toolbar">
