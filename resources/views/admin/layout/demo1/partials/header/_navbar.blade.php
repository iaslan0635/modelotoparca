...
<div class="app-navbar flex-shrink-0">
	...
	<div class="app-navbar-item align-items-stretch ms-1 ms-lg-3">
        {{ theme()->getview('admin.partials/search/_dropdown', ['toggleBtnClass' => $btnClass]) }}
	</div>
	<!--end::Search-->
	<!--begin::Activities-->
	...
	<div class="app-navbar-item ms-1 ms-lg-3">
		...
		{{ theme()->getview('admin.partials/menus/_notifications-menu') }}
		<!--end::Menu wrapper-->
	</div>
	<!--end::Notifications-->
	<!--begin::Chat-->
	...
	<div class="app-navbar-item ms-1 ms-lg-3">
		...
		{{ theme()->getview('admin.partials/menus/_quick-links-menu') }}
		<!--end::Menu wrapper-->
	</div>
	<!--end::Quick links-->
	<!--begin::Theme mode-->
	<div class="app-navbar-item ms-1 ms-lg-3">
		{{ theme()->getview('admin.partials/theme-mode/_main') }}
	</div>
	<!--end::Theme mode-->
	<!--begin::User menu-->
