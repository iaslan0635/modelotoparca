		...
		<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
			...
			@if(theme()->getOption('layout', 'header/left') === 'menu')
				<div class="d-flex align-items-stretch" id="kt_header_nav">
                    {{ theme()->getview('admin.layout/header/_menu') }}
				</div>
			@elseif(theme()->getOption('layout', 'header/left') === 'page-title')
				<div class="d-flex align-items-center" id="kt_header_nav">
					{{ theme()->getview('admin.layout/page-title/_' . theme()->getOption('layout', 'page-title/layout')) }}
				</div>
			@endif
			<!--end::Navbar-->
	        ...
	        <div class="d-flex align-items-stretch flex-shrink-0">
                {{ theme()->getview('admin.layout/header/__topbar') }}
			</div>
			<!--end::Topbar-->
		</div>
		<!--end::Wrapper-->
