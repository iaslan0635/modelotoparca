...
<div class="d-flex align-items-stretch flex-shrink-0">
    ...
    <div class="d-flex align-items-stretch {{ $toolbarButtonMarginClass }}">
        {{ theme()->getview('admin.partials/search/_base') }}
    </div>
    <!--end::Search-->
    ...
    {{ theme()->getview('admin.partials/topbar/_quick-links-menu', array('quick-bg' => 'misc/header-bg-demo4.png')) }}
    <!--end::Menu wrapper-->
    </div>
    <!--end::Quick links-->
    ...
    {{ theme()->getview('admin.partials/topbar/_notifications-menu', array('notifications-bg' => 'misc/header-bg-demo4.png')) }}
    <!--end::Menu wrapper-->
    </div>
    <!--end::Notifications-->
    ...
    {{ theme()->getview('admin.partials/topbar/_user-menu') }}
    <!--end::Menu wrapper-->
    </div>
    <!--end::User -->
