...
>
	...
	<div class="header-container {{ theme()->printHtmlClasses('header-container', false) }}">
        {{ theme()->getview('admin.layout/_page-title') }}

        <!--begin::Wrapper-->
        <div class="d-flex align-items-center flex-wrap">
            <!--begin::Search-->
            <div class="header-search py-3 py-lg-0">
                {{ theme()->getview('admin.layout/search/_base') }}
            </div>
            <!--end::Search-->
            ...
            <div class="d-flex align-items-center py-3 py-lg-0">
                <div class="me-3">
                    ...
                    {{ theme()->getview('admin.partials/topbar/_notifications-menu') }}
                </div>
                ...
                <div class="me-3">
                    ...
                    {{ theme()->getview('admin.partials/topbar/_user-menu', array('language-menu-placement' => 'right-start', 'subscription-menu-placement' => 'right-start')) }}
                </div>
