...
<div
	...
	<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
		...
		<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
			 {{ theme()->getview('admin.layout/aside/__tabs') }}
		</div>
		<!--end::Nav-->
		...
		<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
			...
			<div class="d-flex align-items-center mb-2">
				...
				>
				 ...
				 {{ theme()->getview('admin.partials/topbar/_quick-links-menu', array('quick-bg' => 'misc/dropdown-header-bg.png')) }}
				<!--end::Menu wrapper-->
			</div>
			<!--end::Quick links-->
			...
			<div class="d-flex align-items-center mb-2">
				...
				<div class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
				 ...
				 {{ theme()->getview('admin.partials/topbar/_notifications-menu', array('notifications-bg' => 'misc/dropdown-header-bg.png')) }}
				<!--end::Menu wrapper-->
			</div>
			<!--end::Notifications-->
			...
			<div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
				...
				>
				 ...
				 {{ theme()->getview('admin.partials/topbar/_user-menu', array('language-menu-placement' => 'right-end', 'subscription-menu-placement' => 'right-end')) }}
				<!--end::Menu wrapper-->
			</div>
			<!--end::User-->
		</div>
	...
	@if(theme()->getOption('layout', 'aside/secondary-display') === true)
		...
		<div class="aside-secondary d-flex flex-row-fluid">
			...
			<div class="aside-workspace my-5 p-5" id="kt_aside_wordspace">
				 {{ theme()->getview('admin.layout/aside/__tab-contents/_base') }}
			</div>
			<!--end::Workspace-->
		</div>
		<!--end::Secondary-->
