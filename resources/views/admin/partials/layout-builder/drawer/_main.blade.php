...
<div
	...
	<div class="card border-0 shadow-none rounded-0 w-100">
		{{ theme()->getview('admin.partials/layout-builder/drawer/__header') }}
		...
		<div class="card-body position-relative" id="kt_app_layout_builder_body">
			...
			<div id="kt_app_settings_content"
				...
				<form class="form" method="POST" id="kt_app_layout_builder_form" action="{{ route('layout-builder.store') }}">
					...
					{{ theme()->getview('admin.partials/layout-builder/drawer/__form') }}
				</form>
				<!--end::Form-->
			</div>
			<!--end::Content-->
		...
		{{ theme()->getview('admin.partials/layout-builder/drawer/__footer') }}
	</div>
	<!--end::Card-->
</div>
<!--end::App layout builder-->

{{ theme()->getview('admin.partials/layout-builder/drawer/__toggle') }}
