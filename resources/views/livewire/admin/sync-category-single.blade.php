<tr>
    ...
    <td>
        @if($category->merchants()->n11()->exists())
            Eşleştirilmiş
        @else
            <select name="n11_id" id="n11_id" wire:model="n11_id" wire:change="addN11">
    ...
    <td>
        @if($category->merchants()->hepsiburada()->exists())
            Eşleştirilmiş
        @else
            <select name="hepsiburada_id" id="hepsiburada_id" wire:model="hepsiburada_id" wire:change="addHepsiburada">
    ...
    <td>
        @if($category->merchants()->trendyol()->exists())
            Eşleştirilmiş
        @else
            <select name="trendyol_id" id="trendyol_id" wire:model="trendyol_id" wire:change="addTrendyol">
