    ...
    <div class="vehicle-picker__panel-body">
        <div class="vehicle-form vehicle-form--layout--search">
            <div class="vehicle-form__item vehicle-form__item--select">
                <select class="form-control" wire:change="resetTo('maker')" wire:model="maker" name="maker" aria-label="Aracın Markası" @if(blank($makers)) disabled @endif >
            ...
            <div class="vehicle-form__item vehicle-form__item--select">
                <select class="form-control" wire:change="resetTo('car')" wire:model="car" name="car" aria-label="Aracın Modeli" @if(blank($cars)) disabled @endif >
            ...
            <div class="vehicle-form__item vehicle-form__item--select">
                <select class="form-control" wire:change="resetTo('year')" wire:model="year" name="year" aria-label="Aracın Yılı" @if(blank($years)) disabled @endif >
            ...
            <div class="vehicle-form__item vehicle-form__item--select">
                <select class="form-control" wire:change="resetTo('spesificCar')" wire:model="spesificCar" name="spesificCar" aria-label="Araç Seçiniz" @if(blank($spesificCars)) disabled @endif >
            ...
            <div class="vehicle-form__item vehicle-form__item--select">
                <select class="form-control" wire:change="resetTo('engine')" wire:model="engine" name="engine" aria-label="Aracın Motoru" @if(blank($engines)) disabled @endif >
