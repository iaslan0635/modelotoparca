<div class="aiz-user-sidenav-wrap position-relative z-1 rounded-0">
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom metismenu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item mm-active">
                    <a href="/dashboard" class="aiz-side-nav-link active" aria-expanded="true">
                        ...
                        <span class="aiz-side-nav-text ml-3">Hesabım</span>
                    </a>
                </li>

                <!-- Followed Sellers -->
                <li class="aiz-side-nav-item">
                    <a href="/garage" class="aiz-side-nav-link ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3">Garajım</span>
                    </a>
                </li>
                <!-- Purchase History -->
                <li class="aiz-side-nav-item">
                    <a href="/order-history" class="aiz-side-nav-link ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                ...
                <!-- Earning Points -->
                <li class="aiz-side-nav-item">
                    <a href="/adreslerim" class="aiz-side-nav-link ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3">Adreslerim</span>
                    </a>
                </li>
                <!-- My Wallet -->
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link ">
                        ...
                        <span class="aiz-side-nav-text ml-3">Cüzdanım</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link ">
                        ...
                        <span class="aiz-side-nav-text ml-3">Takip Listem</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link ">
                        ...
                        <span class="aiz-side-nav-text ml-3">Karşılaştırmalarım</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link ">
                        ...
                        <span class="aiz-side-nav-text ml-3">Destek Taleplerim</span>
                        <span class="badge badge-inline badge-success">1</span>
                    </a>
                </li>
                ...
                <!-- Manage Profile -->
                <li class="aiz-side-nav-item">
                    <a href="/edit-profile" class="aiz-side-nav-link ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3">Profili Yönet</span>
                    </a>
                </li>
            ...
            <!-- logout -->
            <a href="/logout" class="btn btn-primary btn-block fs-14 fw-700 mb-5 mb-md-0" style="border-radius: 25px;">Çıkış Yap</a>
        </div>
