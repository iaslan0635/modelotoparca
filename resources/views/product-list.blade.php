...
@section('content')
	...
	C6.1,7.8,6.1,8.4,5.7,8.7z"/>
                                                                    ...
                                                                    <li class="filter-categories__item filter-categories__item--current">
                                                                        ...
                                                                        <div class="filter-categories__counter">{{ $category->deepProductsCount }}</div>
                                                                    </li>
                                                                    @foreach($category->children->sortByDesc("products_count") as $child)
                                                                        <li class="filter-categories__item filter-categories__item--child">
                                                                            <a href="{{ route('category.show', $child) }}">{{ $child->name }}</a>
                                                                            <div class="filter-categories__counter">{{ $child->deepProductsCount }}</div>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="filter__container">
                                                            <div class="filter-vehicle">
                                                                ...
                                                                <div class="filter-vehicle__button">
                                                                    <button type="button" class="btn btn-xs btn-secondary">Yeni Araç Ekle</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="filter__container">
                                                            <div class="filter-price" data-min="500" data-max="1500" data-from="590" data-to="1000">
                                                                ...
                                                                <div class="filter-price__title-button">
                                                                    ...
                                                                    <button type="button" class="btn btn-xs btn-secondary filter-price__button">Filtrele</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card widget widget-products d-none d-lg-block">
                                        ...
                                        <div class="widget-products__list">
                                            <div class="widget-products__item">
                                                <div class="widget-products__image image image--type--product">
                                                    <a href="product-full.html" class="image__body">
                                                        <img loading="lazy" class="image__tag" src="https://web.modelotoparca.com/images/products/product-1-64x64.jpg" alt="">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="widget-products__item">
                                                <div class="widget-products__image image image--type--product">
                                                    <a href="product-full.html" class="image__body">
                                                        <img loading="lazy" class="image__tag" src="https://web.modelotoparca.com/images/products/product-2-64x64.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="widget-products__info">
                                                    <div class="widget-products__name">
                                            ...
                                            <div class="widget-products__item">
                                                <div class="widget-products__image image image--type--product">
                                                    <a href="product-full.html" class="image__body">
                                                        <img loading="lazy" class="image__tag" src="https://web.modelotoparca.com/images/products/product-3-64x64.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="widget-products__info">
                                                    <div class="widget-products__name">
                                            ...
                                            <div class="widget-products__item">
                                                <div class="widget-products__image image image--type--product">
                                                    <a href="product-full.html" class="image__body">
                                                        <img loading="lazy" class="image__tag" src="https://web.modelotoparca.com/images/products/product-4-64x64.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="widget-products__info">
                                                    <div class="widget-products__name">
                                            ...
                                            <div class="widget-products__item">
                                                <div class="widget-products__image image image--type--product">
                                                    <a href="product-full.html" class="image__body">
                                                        <img loading="lazy" class="image__tag" src="https://web.modelotoparca.com/images/products/product-5-64x64.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="widget-products__info">
                                                    <div class="widget-products__name">
	...
	C6,14.8,5.8,15,5.5,15h-2C3.2,15,3,14.8,3,14.5v-3C3,11.2,3.2,11,3.5,11z"/>
                                        ...
                                        <div class="view-options__layout layout-switcher">
                                            <div class="layout-switcher__list">
                                                <button type="button" data-layout-id="1" class="layout-switcher__button" data-layout="grid" data-with-features="false">
	...
	C0,0.4,0.4,0,0.8,0h5.4C6.6,0,7,0.4,7,0.8v5.4C7,6.6,6.6,7,6.2,7z"/>
                                                ...
                                                <button type="button" data-layout-id="2" class="layout-switcher__button" data-layout="grid" data-with-features="true">
                                                    <svg width="16" height="16">
                                                        <path d="M16,0.8v14.4c0,0.4-0.4,0.8-0.8,0.8H9.8C9.4,16,9,15.6,9,15.2V0.8C9,0.4,9.4,0,9.8,0l5.4,0C15.6,0,16,0.4,16,0.8z M7,0.8
	v14.4C7,15.6,6.6,16,6.2,16H0.8C0.4,16,0,15.6,0,15.2L0,0.8C0,0.4,0.4,0,0.8,0l5.4,0C6.6,0,7,0.4,7,0.8z"/>
                                                    </svg>
                                                </button>
                                                <button type="button" data-layout-id="3" class="layout-switcher__button layout-switcher__button--active" data-layout="list"
	...
	H0.8C0.4,7,0,6.6,0,6.2V0.8C0,0.4,0.4,0,0.8,0h14.4C15.6,0,16,0.4,16,0.8v5.4C16,6.6,15.6,7,15.2,7z"/>
                                                ...
                                                <button type="button" data-layout-id="4" class="layout-switcher__button" data-layout="table" data-with-features="false">
                                                    <svg width="16" height="16">
	...
	C0.4,4,0,3.6,0,3.2V0.8C0,0.4,0.4,0,0.8,0h14.4C15.6,0,16,0.4,16,0.8v2.4C16,3.6,15.6,4,15.2,4z"/>
                                        ...
                                        <div class="view-options__legend">
                                            {{ $products->total() }} adet üründen {{ $products->perPage() }} tanesi gösteriliyor
                                        </div>
                                ...
                                <div class="products-view__list products-list products-list--grid--4" data-layout="list" data-with-features="false">
                                    <div class="products-list__head">
                                        ...
                                        <div class="products-list__column products-list__column--meta">Producer Code</div>
                                            ...
                                            <div class="products-list__item">
                                                <div class="product-card">
                                                    <div class="product-card__actions-list">
                                                        <button class="product-card__action product-card__action--quickview" data-slug="{{ $product->slug }}" type="button"
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z"/>
                                                    ...
                                                    <div class="product-card__image">
                                                        <div class="image image--type--product">
                                                            <a href="#" class="image__body">
                                                                <img loading="lazy" class="image__tag" src="{{ $product->imageUrl() }}" alt="">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span class="product-card__meta-title">Producer Code:</span> {{ $product->producer_code }}
                                                        </div>
                                                    ...
                                                    <div class="product-card__footer">
                                                        <div class="product-card__prices">
                                                            <div class="product-card__price product-card__price--current">{{ $product->price->formattedPrice }}</div>
                                                        </div>
