                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="menuProducts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li><a href="#" class="nav-link">Kategoriler</a></li>
...
{{--                <!-- Dashboard -->--}}
{{--                <li class="nav-item">--}}
{{--                    <a class="nav-link menu-link" href="{{ route('panel.dashboard') }}">--}}
{{--                        <i class="ri-dashboard-line"></i> <span>Kontrol Paneli</span>--}}
{{--                    </a>--}}
{{--                </li>--}}
...
{{--                    <div class="collapse menu-dropdown" id="menuProducts">--}}
{{--                        <ul class="nav nav-sm flex-column">--}}
{{--                            <li><a href="{{ route('products.index') }}" class="nav-link">Tüm Ürünler</a></li>--}}
{{--                            <li><a href="{{ route('products.create') }}" class="nav-link">Ürün Ekle</a></li>--}}
{{--                            <li><a href="{{ route('categories.index') }}" class="nav-link">Kategoriler</a></li>--}}
{{--                            <li><a href="{{ route('brands.index') }}" class="nav-link">Markalar</a></li>--}}
{{--                            <li><a href="{{ route('stocks.index') }}" class="nav-link">Stok Takibi</a></li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </li>--}}
...
{{--                    <div class="collapse menu-dropdown" id="menuOrders">--}}
{{--                        <ul class="nav nav-sm flex-column">--}}
{{--                            <li><a href="{{ route('orders.index') }}" class="nav-link">Sipariş Listesi</a></li>--}}
{{--                            <li><a href="{{ route('returns.index') }}" class="nav-link">İade Talepleri</a></li>--}}
{{--                            <li><a href="{{ route('invoices.index') }}" class="nav-link">Faturalar</a></li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </li>--}}
...
{{--                    <div class="collapse menu-dropdown" id="menuCustomers">--}}
{{--                        <ul class="nav nav-sm flex-column">--}}
{{--                            <li><a href="{{ route('customers.index') }}" class="nav-link">Müşteri Listesi</a></li>--}}
{{--                            <li><a href="{{ route('reviews.index') }}" class="nav-link">Yorumlar</a></li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </li>--}}
...
{{--                    <div class="collapse menu-dropdown" id="menuMarketplaces">--}}
{{--                        <ul class="nav nav-sm flex-column">--}}
{{--                            <li><a href="{{ route('marketplaces.trendyol') }}" class="nav-link">Trendyol</a></li>--}}
{{--                            <li><a href="{{ route('marketplaces.hepsiburada') }}" class="nav-link">Hepsiburada</a></li>--}}
{{--                            <li><a href="{{ route('marketplaces.amazon') }}" class="nav-link">Amazon</a></li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </li>--}}
...
{{--                    <div class="collapse menu-dropdown" id="menuDiscounts">--}}
{{--                        <ul class="nav nav-sm flex-column">--}}
{{--                            <li><a href="{{ route('discounts.index') }}" class="nav-link">İndirimler</a></li>--}}
{{--                            <li><a href="{{ route('coupons.index') }}" class="nav-link">Kuponlar</a></li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </li>--}}
...
{{--                    <div class="collapse menu-dropdown" id="menuReports">--}}
{{--                        <ul class="nav nav-sm flex-column">--}}
{{--                            <li><a href="{{ route('reports.sales') }}" class="nav-link">Satış Raporları</a></li>--}}
{{--                            <li><a href="{{ route('reports.stock') }}" class="nav-link">Stok Raporları</a></li>--}}
{{--                            <li><a href="{{ route('reports.customers') }}" class="nav-link">Müşteri Raporları</a></li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </li>--}}
...
{{--                        <ul class="nav nav-sm flex-column">--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="/admin" class="nav-link" data-key="t-analytics"> Dashboard </a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="/admin/panel" class="nav-link" data-key="t-crm"> Dashboard2 </a>--}}
{{--                            </li>--}}
