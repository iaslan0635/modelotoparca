	...
	c-3.9,0-7,3.1-7,7s3.1,7,7,7s7-3.1,7-7S18.9,2,15,2z M16,13h-2v-3h-3V8h3V5h2v3h3v2h-3V13z"/>
                                    ...
                                    <div class="owl-carousel">
                                        @foreach($product->images as $image)
                                            <a class="image image--type--product" href="{{ $image->url }}" target="_blank" data-width="700" data-height="700">
                                    ...
                                    <div class="product__info-body">
                                        ...
                                        <div class="product__prices-stock">
                                            <div class="product__prices">
                                                <div class="product__price product__price--current">{{ $product->price->formattedPrice }}</div>
                                            </div>
                                    ...
                                    <div class="product__tags-and-share-links">
                                        ...
                                        <div class="product__share-links share-links">
                                            <ul class="share-links__list">
                                                ...
                                                <li class="share-links__item share-links__item--type--tweet"><a href="">Tweetter</a></li>
                                                <li class="share-links__item share-links__item--type--pin"><a href="">Pin It</a></li>
                                                <li class="share-links__item share-links__item--type--counter"><a href="">Paylaş</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                                     ...
                                                     <div class="col">
                                                         <div class="card">
                                                             <div class="card-header" id="compat-cars-{{ $loop->index }}-header">
                                                                 <button class="uyumluSelectButtons active" type="button" data-toggle="collapse"
...
{{--                                                                          src="https://websitem.modelotoparca.com/public/maker/{{ $brand }}.png" style="max-height: 30px;"  alt="" data-ll-status="loaded">--}}
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z"></path>
                                                            ...
                                                            <div class="product-card__info">
                                                                <div class="product-card__meta">{{ $cross->producercode }}</div>
                                                                <div class="product-card__name">
                                                                    <div>
{{--                                                                        {{ asset('images/brands') }}--}}
                                                                          <div class="product-card__badges">
                                                                              <img style="max-width: 60px; max-height: 30px;" src="https://web.modelotoparca.com/images/brands/{{ $cross->brand->name}}.png" alt="">
                                                                              |
                                                                        </div>
                                                            ...
                                                            <div class="product-card__footer">
                                                                <div class="product-card__prices">
                                                                    <div class="product-card__price product-card__price--current">{{ $cross->price->formattedPrice }}</div>
                                                                </div>
                                                              <a href="{{ route('product.show', $cross) }}">  <button class="product-card__addtocart-icon" type="button" aria-label="Add to cart">
                                                                    <svg width="20" height="20">
{{--                                                                        <circle cx="7" cy="17" r="2"></circle>--}}
{{--                                                                        <circle cx="15" cy="17" r="2"></circle>--}}
                                                                        <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z" id="mainIconPathAttribute"></path>
                                                                        <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z" id="mainIconPathAttribute"></path>
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z"></path>
                                                            ...
                                                            <div class="product-card__info">
                                                                ...
                                                                <div class="product-card__name">
                                                                    <div>
                                                                        <div class="product-card__badges">
                                                                            <div class="tag-badge tag-badge--sale">{{ $cross->brand->name }}</div>
                                                                        </div>
                                                                        <a href="{{ route('product.show', $cross) }}">{{ $cross->fullTitle }}</a>
                                                                    </div>
                                                                </div>
