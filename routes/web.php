...
Route::get('/', function () {
    $categories = Category::root()->limit(16)->orderBy("order")->get(["slug", "name"]);
    $featured_products = Product::query()->limit(20)->with("price:id,price,currency")->get(["id", "slug" ,"sku", "title"]);
